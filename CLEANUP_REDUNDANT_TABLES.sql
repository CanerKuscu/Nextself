-- ============================================
-- CLEANUP - DELETE REDUNDANT TABLES
-- Backup and remove unnecessary tables
-- ============================================

-- ⚠️ WARNING: This will delete 31 redundant tables
-- Make sure you have backups before running!

-- 🎮 VIDEO SYSTEM (7 tables)
...
DROP TABLE IF EXISTS public.user_friends_view CASCADE;
