-- ============================================
-- BIOSYNC MISSING TABLES - FINAL FIXED VERSION
-- Handles all column conflicts properly
-- ============================================
...
CREATE TABLE IF NOT EXISTS public.minerals (
    ...
    category TEXT,
    description TEXT,
    daily_recommendation DECIMAL(8,2),
    unit TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- ============================================
-- RECREATE VIEWS (with non-conflicting column names)
-- ============================================
...
-- Minerals
CREATE INDEX IF NOT EXISTS idx_minerals_name ON public.minerals(name);
CREATE INDEX IF NOT EXISTS idx_minerals_name_tr ON public.minerals(name_tr);
CREATE INDEX IF NOT EXISTS idx_minerals_category ON public.minerals(category);
