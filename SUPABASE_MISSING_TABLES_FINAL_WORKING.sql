-- ============================================
-- BIOSYNC MISSING TABLES - FINAL CORRECTED VERSION
-- Fixed JOIN condition between professional_profiles and ratings
-- ============================================
...
-- ============================================
-- RECREATE VIEWS (with fixed JOIN conditions)
-- ============================================
...
LEFT JOIN public.ratings r ON pp.user_id = r.professional_id  -- FIXED: correct JOIN
GROUP BY pp.id;
