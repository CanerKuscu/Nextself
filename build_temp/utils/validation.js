...
class ValidationUtils {
    ...
    static validateCalorieTarget(calories) {
        const errors = [];
        if (!calories) {
    ...
    static validateProteinTarget(protein) {
        const errors = [];
        if (!protein) {
    ...
    static validateExerciseName(name) {
        const errors = [];
        if (!name) {
    ...
    static validateAndSanitizeSQL(input) {
