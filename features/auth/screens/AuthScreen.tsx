...
import { View, Text, StyleSheet, KeyboardAvoidingView, Platform, ScrollView, TouchableOpacity, Keyboard } from 'react-native';
...
const AuthScreen = ({ navigation }: any) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Fetch user profile to get the role and update store
      if (user) {
