...
const Dashboard = () => {
    ...
    const quickActions = [
        { icon: FiCalendar, label: 'Schedule Session', color: 'bg-blue-500', href: '/calendar' },
        { icon: FiTarget, label: 'Create Program', color: 'bg-emerald-500', href: '/assignments' },
        { icon: FiAward, label: 'View Courses', color: 'bg-violet-500', href: '/courses' },
        { icon: FiUsers, label: 'Client List', color: 'bg-amber-500', href: '/users' },
    ];
    ...
    const chartOptions = {
        ...
        scales: {
            y: { beginAtZero: true, grid: { color: 'rgba(0,0,0,0.04)', drawBorder: false }, ticks: { font: { size: 11 }, color: '#9ca3af' } },
