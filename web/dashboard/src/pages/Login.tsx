        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">NextSelf Professional</h2>
                ...
                <div className="text-center">
                    ...
                    <p className="text-center text-xs text-gray-400 mt-2 max-w-sm mx-auto">
                        This is a secure professional panel for NextSelf Personal Trainers and Dietitians.
                    </p>
                </div>
            </div>
        </div>
